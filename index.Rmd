...
#acknowledgements .chart-title {
  display: none;
}

#shiny-modules .image-container {
  top: 60px;
}
...
For a realtime demo of the app you can clone the app from [the github repo](https://github.com/tbilab/multimorbidity_explorer). 

To run the app using docker to avoid dependency installation woes the [provided docker image](https://github.com/tbilab/me_docker) and it's installation instructions will help you! 
