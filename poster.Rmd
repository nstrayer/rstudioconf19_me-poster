...
#### `r icon::fa('hand-point-up',fixed_width = TRUE)` Interacting with results 
...
#### `r icon::fa('expand-arrows-alt',fixed_width = TRUE)` Expanding past plain associations
